...
def Authorize(
	authorized: bool | None = None, staff: bool = False, admin: bool = False, permissions: list[str] | None = None,  # noqa: FBT001
):
	if callable(authorized):
		return Authorize(authorized=True, staff=staff, admin=admin, permissions=permissions)(authorized)
...
def Authenticate(staff=False, admin=False, permissions: list[str] | None = None):
